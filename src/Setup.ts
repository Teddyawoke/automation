...
function setupSheetArchitecture(): void {
...
function setupControlTab(ss: GoogleAppsScript.Spreadsheet.Spreadsheet): void {
...
function setupPromptTab(ss: GoogleAppsScript.Spreadsheet.Spreadsheet): void {
...
function setupHeaders(sheet: GoogleAppsScript.Spreadsheet.Sheet | null, headers: string[]): void {
  if (sheet && sheet.getLastRow() === 0) {
